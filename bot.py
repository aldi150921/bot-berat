...
LANG = {
    ...
    "en": {
        ...
        "katalog":    "🛍️  Product Catalog",
        "keranjang":  "🛒  Cart",
        "pesanan":    "📋  Orders",
        "kontak":     "📞  Contact Us",
        "admin":      "⚙️  Admin Panel",
        "kembali":    "« Back to Menu",
        "pilih_kat":  "🛍️ *Choose Product Category:*\n\nWe have various digital products.",
        "semua":      "📦 All Products",
        "back":       "« Back",
...
async def cb_menu(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── KATALOG ──
        ...
        btns.append([InlineKeyboardButton(t(ctx, "semua"), callback_data="cat:SEMUA")])
